...
use "C:\Users\Administrator\Desktop\Life_Expectancy\data_updated.dta", clear
...
xtreg life_exp urban_pop unemployment bottom_50per_income gni10000, fe vce(cluster id_country)
outreg2 using fixed_effects_model.xls, replace ctitle(Model 1)

/*Model 2: Health Factors*/
xtreg life_exp ghe_per ghe10000 immune, fe vce(cluster id_country)
outreg2 using fixed_effects_model.xls, append ctitle(Model 2)

/*Model 3: All Variables*/
xtreg life_exp urban_pop unemployment bottom_50per_income gni10000 ghe_per ghe10000 immune, fe vce(cluster id_country)
outreg2 using fixed_effects_model.xls, append ctitle(Model 3)

/*Model 4: Economic Variables and Time Fixed Effects*/
xtreg life_exp urban_pop unemployment bottom_50per_income gni10000 i.year, fe vce(cluster id_country)
outreg2 using fixed_effects_model.xls, append ctitle(Model 4)

/*Model 5: Health Factors and Time Fixed Effects*/
xtreg life_exp ghe_per ghe10000 immune i.year, fe vce(cluster id_country)
outreg2 using fixed_effects_model.xls, append ctitle(Model 5)

/*Model 6: All Variables and Time Fixed Effects*/
xtreg life_exp urban_pop unemployment bottom_50per_income gni10000 ghe_per ghe10000 immune i.year, fe vce(cluster id_country)
